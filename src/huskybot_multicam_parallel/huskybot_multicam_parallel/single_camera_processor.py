#!/usr/bin/env python3
# filepath: /home/jezzy/huskybot_v11/src/huskybot_multicam_parallel/huskybot_multicam_parallel/single_camera_processor.py
...
class SingleCameraProcessor(Node):
    def __init__(self):
        ...
        self.text_color = (0, 0, 0)  # Warna font hitam
    ...
    def get_distinct_coco_color(self, class_id):
        """Get distinct bright colors for all COCO classes"""
        colors = [
            (255, 100, 100), (100, 255, 100), (100, 100, 255), (255, 255, 100), (255, 100, 255),
            (100, 255, 255), (255, 180, 100), (180, 100, 255), (255, 200, 230), (100, 200, 200),
            (200, 200, 100), (255, 200, 100), (200, 100, 255), (255, 150, 200), (100, 220, 255),
            (150, 255, 150), (255, 150, 100), (200, 150, 255), (255, 240, 100), (255, 120, 160),
            (100, 255, 200), (255, 160, 220), (130, 180, 255), (255, 180, 120), (200, 100, 255),
            (255, 150, 150), (100, 230, 230), (255, 240, 200), (180, 255, 100), (255, 100, 180),
            (150, 200, 255), (255, 200, 180), (150, 220, 200), (255, 210, 220), (180, 230, 255)
        ]
        return colors[class_id % len(colors)]

    def get_contrasting_text_color(self, bg_color):
        """Get contrasting text color - always return black for better readability"""
        return (0, 0, 0)  # Always black text
            ...
            for detection in detections:
                ...
                if detection['mask'] is not None:
                    try:
                        ...
                        alpha = 0.25  # Lower opacity for more transparency
                ...
                info_lines = [
                    ...
                    f"Coordinate: ({detection['x']:.1f}, {detection['y']:.1f}, {detection['z']:.1f})"
                                ...
                                # ✅ CLEAN TEXT SIZE - OPTIMAL size for readability
                font_scale = 1.4  # OPTIMAL size - not too big, not too small
                font_thickness = 2  # REDUCED from 6 for cleaner look
                line_height = 50  # REDUCED from 75 for tighter spacing
                ...
                # ✅ TRANSPARENT BACKGROUND - SEMI-TRANSPARENT for better visibility
                ...
                # Main background
                cv2.rectangle(overlay, (text_x-3, text_y-3), 
                ...
                cv2.putText(canvas, line, 
                           ...
                           cv2.FONT_HERSHEY_SIMPLEX, font_scale, self.text_color, font_thickness)
