...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'lidar_camera_fusion_node = huskybot_multicam_parallel.lidar_camera_fusion_node:main',
            'multicamera_lidar_fusion_node = huskybot_multicam_parallel.multicamera_lidar_fusion_node:main',
            'auto_calibration_node = huskybot_multicam_parallel.auto_calibration_node:main',
            'sensor_fusion_accuracy_test = huskybot_multicam_parallel.sensor_fusion_accuracy_test:main',
        ],
    },
)
