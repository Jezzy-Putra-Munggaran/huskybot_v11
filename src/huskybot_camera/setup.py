#!/usr/bin/env python3
# filepath: /home/jezzy/huskybot_v11/src/huskybot_camera/setup.py
...
try:
    ...
    pass  # print(f"[WARNING] Skipping validation: {e}") - commented out to avoid colcon build issues
...
# NOTE: Semua print statements dihapus karena menyebabkan syntax error saat colcon build
